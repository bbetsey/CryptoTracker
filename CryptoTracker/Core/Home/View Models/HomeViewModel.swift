...
class HomeViewModel: ObservableObject {
    ...
    @Published var detailSatistics: [Statistic] = []
...
private extension HomeViewModel {
    ...
    func mapAllCoinsToPortfolioCoins(allCoins: [Coin], portfolioEntities: [PortfolioEntity]) -> [Coin] {
        allCoins
            .compactMap { coin in
